...
const BookingForm = () => {
  ...
  const isCheckInDateValid = () => {
    if (!moment(booking.checkInDate).isAfter(moment(), "day")) {
                  ...
                  <div className="row">
                    <div className="col-6">
                      ...
                      <FormControl
                        ...
                        min={moment().format("YYYY-MM-DD")} // Format ISO requis ici
                        onChange={handleInputChange}
                        isInvalid={
                          validated &&
                          (!booking.checkInDate ||
                            !moment(booking.checkInDate).isAfter(
                              moment(),
                              "day"
                            ))
                        }
                      />
                      <Form.Control.Feedback type="invalid">
                        Please select a correct check in date.
                      </Form.Control.Feedback>
                    </div>
